...
namespace Visual_Lab1
{
    public class DataToSave
    {
        ...
        public DataToSave(Form1 calculator)
        {
        ...
        public Form1.States CurrentState { get; set; }
    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            reader.Dispose();
            var calculator = new Form1(save as DataToSave);
        ...
        {
            var save = new DataToSave(sender as Form1);
